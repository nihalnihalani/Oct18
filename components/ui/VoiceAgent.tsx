...
export default function VoiceAgent({ 
  ...
  // Generate summary and process commands
...
If the user wants to create content, use the creative brief to generate a detailed, professional prompt.`
  ...
  useEffect(() => {
    // For now, we'll use a mock implementation since Vapi keys aren't configured
    const mockVapiInstance = {
      start: () => {
        ...
        setTimeout(() => {
          setConversationHistory([
            { role: 'user', text: 'I want to create a video of a sunset over mountains' },
            { role: 'assistant', text: 'I\'ll help you create a beautiful sunset mountain video. Let me generate that for you.' }
          ])
        }, 2000)
